...
let cases = {
  ...
  'exotic numbers': [
    ...
    {
      value: -Infinity,
      bytes: [types.FLOAT32, 0x00, 0x00, 0x80, 0xFF],
      desc: '-Infinity as float'
    },
    {
      value: Infinity,
      bytes: [types.FLOAT32, 0x00, 0x00, 0x80, 0x7F],
      desc: 'Infinity as float'
    },
    {
      value: NaN,
      bytes: [types.FLOAT32, 0x00, 0x00, 0xC0, 0x7F],
      desc: 'NaN as float'
    }
  ],
  'positive integers': [
  ...
  'floats and doubles': [
    {
      value: 0.5,
      bytes: [types.FLOAT32, 0x00, 0x00, 0x00, 0x3F],
      desc: '0.5 as float'
    },
    {
      value: 0.15625,
      bytes: [types.FLOAT32, 0x00, 0x00, 0x20, 0x3E],
      desc: '0.15625 as float'
    },
    {
      value: 4.125,
      bytes: [types.FLOAT32, 0x00, 0x00, 0x84, 0x40],
      desc: '4.125 as float'
    },
    {
      value: -0.15625,
      bytes: [types.FLOAT32, 0x00, 0x00, 0x20, 0xBE],
      desc: '-0.15625 as float'
    },
    {
      value: -4.125,
      bytes: [types.FLOAT32, 0x00, 0x00, 0x84, 0xC0],
      desc: '-4.125 as float'
    },
    {
      value: 0.1,
      bytes: [types.DOUBLE64, 0x9A, 0x99, 0x99, 0x99, 0x99, 0x99, 0xB9, 0x3F],
      desc: '0.1 as double'
    },
    {
      value: 1 / 3,
      bytes: [types.DOUBLE64, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0xD5, 0x3F],
      desc: '1/3 as double'
    },
    {
      value: 1.0000000000000002,
      bytes: [types.DOUBLE64, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF0, 0x3F],
      desc: '1.0000000000000002 as double'
    },
    {
      value: 1.0000000000000004,
      bytes: [types.DOUBLE64, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF0, 0x3F],
      desc: '1.0000000000000004 as double'
    },
    {
      value: 123.456,
      bytes: [types.DOUBLE64, 0x77, 0xBE, 0x9F, 0x1A, 0x2F, 0xDD, 0x5E, 0x40],
      desc: '123.456 as double'
    },
    {
      value: -0.1,
      bytes: [types.DOUBLE64, 0x9A, 0x99, 0x99, 0x99, 0x99, 0x99, 0xB9, 0xBF],
      desc: '-0.1 as double'
    },
    {
      value: -1 / 3,
      bytes: [types.DOUBLE64, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55, 0xD5, 0xBF],
      desc: '-1/3 as double'
    },
    {
      value: -654.321,
      bytes: [types.DOUBLE64, 0x21, 0xB0, 0x72, 0x68, 0x91, 0x72, 0x84, 0xC0],
